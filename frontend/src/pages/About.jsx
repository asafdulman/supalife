...
export function About() {
    ...
    return (
        <div className="about-box">
            ...
            <hr />
            <p>For example, let's take Jane Doe. When she reflects on how her day was, she can say to herself that it was great. She had a great presentation at work and her boss loved it. Then on the way home a nice guy asked her number. </p>
